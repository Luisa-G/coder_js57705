...
class Visitante {
    constructor(nombre, telefono, ciudad, consumo) {
        this.nombre = nombre;
...
crearVisitante = () => {
    ...
    consumo = prompt("Indica tu consumo mensual en kWh:");
    let usuario = visitantes.push(new Visitante(nombre, telefono, ciudad, consumo));
    return usuario;
}
...
// const porCiudad = visitantes.filter(usuario,"Chihuahua")
